/* =====================================================================
   ملاحظة: هذي نسخة من نفس ملف config.js الموجود بمجلد التطبيق الرئيسي.
   لازم تحط فيها نفس القيم بالضبط (SUPABASE_URL و SUPABASE_KEY) حتى أي
   عمل يستورده مجلد "رفع" يوصل لنفس مكتبة بيور اللي يشوفها التطبيق
   الرئيسي. إذا عدّلت وحدة، عدّل الثانية معاها بنفس القيم.
   ===================================================================== */
